...
ObjectsFileList        :=$(IntermediateDirectory)/BLE2G4_peripheral.txt
...
IncludePackagePath     :=
IncludeCPath           := $(IncludeSwitch). $(IncludeSwitch).. $(IncludeSwitch)../../../components/ble/app $(IncludeSwitch)../../../components/ble/ota_service $(IncludeSwitch)../../../components/ble/service $(IncludeSwitch)../../../components/ble/v0/utils $(IncludeSwitch)../../../components/core/cp8000 $(IncludeSwitch)../../../components/core/riscv/E902 $(IncludeSwitch)../../../components/core/riscv/E902/cp8000 $(IncludeSwitch)../../../components/core/riscv/E902/t1001 $(IncludeSwitch)../../../components/core/t1001 $(IncludeSwitch)../../../components/driver $(IncludeSwitch)../../../components/header $(IncludeSwitch)../../../components/libraries $(IncludeSwitch)../../../components/libraries/24g $(IncludeSwitch)../../../components/libraries/ble $(IncludeSwitch)../../../components/misc $(IncludeSwitch)../../../modules/ble_viot $(IncludeSwitch)../../../modules/hal_adv $(IncludeSwitch)../../../modules/hal_clock $(IncludeSwitch)../../../modules/hal_sleep $(IncludeSwitch)modules/hal_adv $(IncludeSwitch)modules/hal_clock $(IncludeSwitch)modules/hal_gpio $(IncludeSwitch)modules/hal_sleep $(IncludeSwitch)modules/hal_timer  
IncludeAPath           := $(IncludeSwitch)../../../../../../../../../C-Sky/CDK/CSKY/csi/csi_core/csi_cdk/ $(IncludeSwitch)../../../../../../../../../C-Sky/CDK/CSKY/csi/csi_core/include/ $(IncludeSwitch)../../../../../../../../../C-Sky/CDK/CSKY/csi/csi_driver/include/ $(IncludeSwitch). $(IncludeSwitch)../../../components/ble/app $(IncludeSwitch)../../../components/ble/ota_service $(IncludeSwitch)../../../components/ble/service $(IncludeSwitch)../../../components/ble/v0/utils $(IncludeSwitch)../../../components/core/cp8000 $(IncludeSwitch)../../../components/core/riscv/E902 $(IncludeSwitch)../../../components/core/riscv/E902/cp8000 $(IncludeSwitch)../../../components/core/riscv/E902/t1001 $(IncludeSwitch)../../../components/core/t1001 $(IncludeSwitch)../../../components/driver $(IncludeSwitch)../../../components/header $(IncludeSwitch)../../../components/libraries $(IncludeSwitch)../../../components/libraries/24g $(IncludeSwitch)../../../components/libraries/ble $(IncludeSwitch)../../../components/misc $(IncludeSwitch)../../../modules/ble_viot $(IncludeSwitch)../../../modules/hal_adv $(IncludeSwitch)../../../modules/hal_clock $(IncludeSwitch)../../../modules/hal_sleep $(IncludeSwitch)modules/hal_adv $(IncludeSwitch)modules/hal_clock $(IncludeSwitch)modules/hal_gpio $(IncludeSwitch)modules/hal_sleep $(IncludeSwitch)modules/hal_timer  
Libs                   :=
ArLibs                 := 
PackagesLibPath        :=
...
$(IntermediateDirectory)/$(OutputFile):  $(Objects) Always_Link 
	...
	@BLE2G4_peripheral.modify.bat $(IntermediateDirectory) $(OutputFile)$(ExeSuffix) 
...
## Objects
##
$(IntermediateDirectory)/BLE2G4_peripheral_main$(ObjectSuffix): ../main.c  
	$(CC) $(SourceSwitch) ../main.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/BLE2G4_peripheral_main$(ObjectSuffix) -MF$(IntermediateDirectory)/BLE2G4_peripheral_main$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/BLE2G4_peripheral_main$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/BLE2G4_peripheral_main$(PreprocessSuffix): ../main.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/BLE2G4_peripheral_main$(PreprocessSuffix) ../main.c

$(IntermediateDirectory)/BLE2G4_peripheral_app_main$(ObjectSuffix): ../app_main.c  
	$(CC) $(SourceSwitch) ../app_main.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/BLE2G4_peripheral_app_main$(ObjectSuffix) -MF$(IntermediateDirectory)/BLE2G4_peripheral_app_main$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/BLE2G4_peripheral_app_main$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/BLE2G4_peripheral_app_main$(PreprocessSuffix): ../app_main.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/BLE2G4_peripheral_app_main$(PreprocessSuffix) ../app_main.c

$(IntermediateDirectory)/BLE2G4_peripheral_app_isr$(ObjectSuffix): ../app_isr.c  
	$(CC) $(SourceSwitch) ../app_isr.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/BLE2G4_peripheral_app_isr$(ObjectSuffix) -MF$(IntermediateDirectory)/BLE2G4_peripheral_app_isr$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/BLE2G4_peripheral_app_isr$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/BLE2G4_peripheral_app_isr$(PreprocessSuffix): ../app_isr.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/BLE2G4_peripheral_app_isr$(PreprocessSuffix) ../app_isr.c
